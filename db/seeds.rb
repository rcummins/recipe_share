...
Instruction.create([
  ...
  {recipe_id: apple_pie.id,
    step_number: 3,
    instruction: 'Toss the apples slices with the corn starch, sinnamon, nutmeg, salt, lemon juice and 3/4 cups sugar.'},
  {recipe_id: apple_pie.id,
    step_number: 4,
...
Ingredient.create([
  ...
  {recipe_id: green_bean_casserole.id,
    item_number: 9,
    ingredient: '1 1/2 cup shredded Gruyere'},
  {recipe_id: green_bean_casserole.id,
    item_number: 10,
...
Instruction.create([
  {recipe_id: green_bean_casserole.id,
    step_number: 1,
    instruction: 'Preheat oven to 375°F. Use 1 tablespoon butter to grease 2 or 2 1/2 quart baking dish.'},
  {recipe_id: green_bean_casserole.id,
    step_number: 2,
